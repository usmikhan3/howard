...
class AirIntroScreen extends StatelessWidget {
  const AirIntroScreen({Key? key}) : super(key: key);
        ...
        child: Container(
          ...
          child: Column(
            children: [
              ...
              RoundedButton(text: "Next", onPress: ()=>Navigator.pushReplacementNamed(context, RouteName.earthIntroView),),

...
class EarthIntroScreen extends StatelessWidget {
  const EarthIntroScreen({Key? key}) : super(key: key);
        ...
        child: Container(
          ...
          decoration:const  BoxDecoration(
              image: DecorationImage(
                image: AssetImage(
                  "assets/images/earth/earth-bg.png",
                ),
                fit: BoxFit.fill,
          ...
          child: Column(
            children: [
              ...
              RoundedButton(text: "Next", onPress: ()=>Navigator.pushReplacementNamed(context, RouteName.loginView),),
